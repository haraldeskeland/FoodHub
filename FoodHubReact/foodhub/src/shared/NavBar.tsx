          ...
          <div className="mx-auto px-4">
            <div className="flex justify-between items-center p-3">
              ...
              <Link to="/" className="flex-shrink-0 drop-shadow-[0_0_25px_rgba(255,255,255,0.4)] hover:drop-shadow-[0_0_25px_rgba(255,255,255,0.8)] transition-all duration-300 ease-in-out">
                <img src="http://localhost:5115/images/Logos/foodhub_logo_black.png" alt="FoodHub logo" className="w-[130px] drop-shadow-xl hover:-translate-y-1 transition-all duration-200 ease-in-out dark:invert" />
              </Link>
              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                >
                  <img src="http://localhost:5115/images/light-dark.png" alt="Light/Dark mode toggle icon" className="w-full h-full filter dark:invert" />
                </button>
              </div>
