...
// API controller for handling item-related requests
[ApiController]
...
public class ItemAPIController : Controller
{
    ...
    // GET: api/ItemAPI/GetAllCategories
    // Action method to get all item categories
    ...
    // Action method to get all items
    [HttpGet("itemlist")]
    ...
    // POST: api/ItemAPI/create
    // Action method to create a new item
    [HttpPost("create")]
    ...
    // GET: api/ItemAPI/{id}
    // Action method to get a specific item by ID
    [HttpGet("{id}")]
    ...
    // PUT: api/ItemAPI/update/{id}
    // Action method to update an existing item
    [HttpPut("update/{id}")]
    ...
    // DELETE: api/ItemAPI/delete/{id}
    // Action method to delete an item by ID
...
// MVC controller for handling item-related requests
